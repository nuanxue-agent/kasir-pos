                ...
                >
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className={cn(
                        'flex-1 px-3 py-2 bg-white border rounded-lg text-stone-800 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent text-sm',
