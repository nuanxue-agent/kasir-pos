        ...
        <div className="grid gap-3">
          {staff.map((member: StaffMember) => (
            <div
              key={member.id}
              className={cn(
                'bg-stone-100 rounded-xl p-4 flex items-center gap-4 border border-stone-200',
...
const inputCls = 'w-full bg-stone-100 border border-stone-200 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder-slate-400 disabled:opacity-50 disabled:cursor-not-allowed'
