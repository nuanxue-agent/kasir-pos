        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative sm:w-64">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent appearance-none bg-white"
            >
