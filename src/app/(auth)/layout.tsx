  ...
  return (
    <div className="min-h-screen bg-[var(--bg-canvas)] text-[var(--text-1)]">
      <div className="flex min-h-screen">
        {/* ── Left panel ── */}
        <div className="relative hidden lg:flex lg:w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-700 p-12">
          {/* Subtle dot pattern */}
          <div
          ...
          <div className="relative z-10 space-y-8">
            <div>
              <h2 className="text-3xl font-bold leading-tight text-white">
                ...
                <span className="text-indigo-200">untung makin besar.</span>
              </h2>
            ...
            <blockquote className="rounded-xl bg-white/10 border border-white/20 p-4 backdrop-blur-sm">
              ...
              <footer className="mt-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-indigo-200"> · Warung Makan Barokah</span>
                </div>
              </footer>
            </blockquote>
          </div>
